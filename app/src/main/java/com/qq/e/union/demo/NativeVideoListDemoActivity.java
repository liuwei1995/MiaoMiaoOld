...
public class NativeVideoListDemoActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.gdt_activity_gdtnative_video_ad);
  ...
  class CustomAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null || convertView.getTag() == null) {
        ...
        switch (type) {
          case TYPE_DATA:
            convertView = View.inflate(mContext, R.layout.gdt_item_data, null);
            holder.title = (TextView) convertView.findViewById(R.id.title);
            break;
          case TYPE_AD:
            convertView = View.inflate(mContext, R.layout.gdt_item_ad, null);
