 ...
 * 小知识 cid = 27
 * 
 * @author lw <27.json> http://open.mb.hd.sohu.com/v4/category/channel/27.json?
 *         api_key=a6719304d387489c3f6b54a56e9f7e87&page=1&is_pgc=1
 */
public class OriginalEntity implements Parcelable {
	...
	public static final Creator<OriginalEntity> CREATOR = new Creator<OriginalEntity>() {

		@Override
		public OriginalEntity[] newArray(int size) {
			return new OriginalEntity[size];
		}

		@Override
		public OriginalEntity createFromParcel(Parcel source) {
			OriginalEntity entivity = new OriginalEntity();
