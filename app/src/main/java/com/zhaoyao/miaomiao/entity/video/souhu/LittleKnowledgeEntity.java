 ...
 * 小知识 cid = 32
 * 
 * @author lw <32.json> http://open.mb.hd.sohu.com/v4/category/channel/32.json?
 *         api_key=a6719304d387489c3f6b54a56e9f7e87&page=1&is_pgc=1
 */
public class LittleKnowledgeEntity implements Parcelable {
	...
	public static final Creator<LittleKnowledgeEntity> CREATOR = new Creator<LittleKnowledgeEntity>() {

		@Override
		public LittleKnowledgeEntity[] newArray(int size) {
			return new LittleKnowledgeEntity[size];
		}

		@Override
		public LittleKnowledgeEntity createFromParcel(Parcel source) {
			LittleKnowledgeEntity entivity = new LittleKnowledgeEntity();
