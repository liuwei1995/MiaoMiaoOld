 ...
 */
public class PublicClassEntity implements Parcelable {
	...
	public static final Creator<PublicClassEntity> CREATOR = new Creator<PublicClassEntity>() {

		@Override
		public PublicClassEntity[] newArray(int size) {
			return new PublicClassEntity[size];
		}

		@Override
		public PublicClassEntity createFromParcel(Parcel source) {
			PublicClassEntity entivity = new PublicClassEntity();
