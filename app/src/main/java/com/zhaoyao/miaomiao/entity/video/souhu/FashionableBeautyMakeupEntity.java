 ...
 */
public class FashionableBeautyMakeupEntity implements Parcelable {
	...
	public static final Creator<FashionableBeautyMakeupEntity> CREATOR = new Creator<FashionableBeautyMakeupEntity>() {

		@Override
		public FashionableBeautyMakeupEntity[] newArray(int size) {
			return new FashionableBeautyMakeupEntity[size];
		}

		@Override
		public FashionableBeautyMakeupEntity createFromParcel(Parcel source) {
			FashionableBeautyMakeupEntity entivity = new FashionableBeautyMakeupEntity();
