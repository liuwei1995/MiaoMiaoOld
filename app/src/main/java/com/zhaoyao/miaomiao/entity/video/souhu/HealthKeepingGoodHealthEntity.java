 ...
 */
public class HealthKeepingGoodHealthEntity implements Parcelable {
	...
	public static final Creator<HealthKeepingGoodHealthEntity> CREATOR = new Creator<HealthKeepingGoodHealthEntity>() {

		@Override
		public HealthKeepingGoodHealthEntity[] newArray(int size) {
			return new HealthKeepingGoodHealthEntity[size];
		}

		@Override
		public HealthKeepingGoodHealthEntity createFromParcel(Parcel source) {
			HealthKeepingGoodHealthEntity entivity = new HealthKeepingGoodHealthEntity();
