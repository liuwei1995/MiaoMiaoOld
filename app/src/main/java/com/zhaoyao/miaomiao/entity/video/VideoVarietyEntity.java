 ...
 *
 */
public class VideoVarietyEntity extends MyParcelable{
	...
	public static final Creator<VideoVarietyEntity> CREATOR = new Creator<VideoVarietyEntity>() {

		@Override
		public VideoVarietyEntity[] newArray(int size) {
			return new VideoVarietyEntity[size];
		}

		@Override
		public VideoVarietyEntity createFromParcel(Parcel source) {
			VideoVarietyEntity entivity = new VideoVarietyEntity();
