 ...
 */
public class FunnyEntity implements Parcelable {
	...
	public static final Creator<FunnyEntity> CREATOR = new Creator<FunnyEntity>() {

		@Override
		public FunnyEntity[] newArray(int size) {
			return new FunnyEntity[size];
		}

		@Override
		public FunnyEntity createFromParcel(Parcel source) {
			FunnyEntity entivity = new FunnyEntity();
