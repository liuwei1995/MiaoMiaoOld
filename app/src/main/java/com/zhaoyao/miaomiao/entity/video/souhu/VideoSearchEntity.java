 ...
 *
 */
public class VideoSearchEntity implements Parcelable{
	...
	public static final Creator<VideoSearchEntity> CREATOR = new Creator<VideoSearchEntity>() {

		@Override
		public VideoSearchEntity[] newArray(int size) {
			return new VideoSearchEntity[size];
		}

		@Override
		public VideoSearchEntity createFromParcel(Parcel source) {
			VideoSearchEntity entivity = new VideoSearchEntity();
...
//	{"status;//200 private String statusText;//"OK" private String data;//
