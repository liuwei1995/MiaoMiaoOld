 ...
 */
public class LearnTestEntity implements Parcelable {
	...
	public static final Creator<LearnTestEntity> CREATOR = new Creator<LearnTestEntity>() {

		@Override
		public LearnTestEntity[] newArray(int size) {
			return new LearnTestEntity[size];
		}

		@Override
		public LearnTestEntity createFromParcel(Parcel source) {
			LearnTestEntity entivity = new LearnTestEntity();
