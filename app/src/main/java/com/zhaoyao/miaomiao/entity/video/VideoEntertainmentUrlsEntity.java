 ...
 *
 */
public class VideoEntertainmentUrlsEntity extends MyParcelable {
	...
	public static final Creator<VideoEntertainmentUrlsEntity> CREATOR = new Creator<VideoEntertainmentUrlsEntity>() {

		@Override
		public VideoEntertainmentUrlsEntity[] newArray(int size) {
			return new VideoEntertainmentUrlsEntity[size];
		}

		@Override
		public VideoEntertainmentUrlsEntity createFromParcel(Parcel source) {
			VideoEntertainmentUrlsEntity entivity = new VideoEntertainmentUrlsEntity();
			return entivity;
		}
	};
