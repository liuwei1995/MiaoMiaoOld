 ...
 */
public class DanceEntity implements Parcelable {
	...
	public static final Creator<DanceEntity> CREATOR = new Creator<DanceEntity>() {

		@Override
		public DanceEntity[] newArray(int size) {
			return new DanceEntity[size];
		}

		@Override
		public DanceEntity createFromParcel(Parcel source) {
			DanceEntity entivity = new DanceEntity();
