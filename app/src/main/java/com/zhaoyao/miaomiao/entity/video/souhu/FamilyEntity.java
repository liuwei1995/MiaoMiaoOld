...
public class FamilyEntity implements Parcelable {
	...
	public static final Creator<FamilyEntity> CREATOR = new Creator<FamilyEntity>() {

		@Override
		public FamilyEntity[] newArray(int size) {
			return new FamilyEntity[size];
		}

		@Override
		public FamilyEntity createFromParcel(Parcel source) {
			FamilyEntity entivity = new FamilyEntity();
