 ...
 */
public class SportsFitnessEntity implements Parcelable {
	...
	public static final Creator<SportsFitnessEntity> CREATOR = new Creator<SportsFitnessEntity>() {

		@Override
		public SportsFitnessEntity[] newArray(int size) {
			return new SportsFitnessEntity[size];
		}

		@Override
		public SportsFitnessEntity createFromParcel(Parcel source) {
			SportsFitnessEntity entivity = new SportsFitnessEntity();
