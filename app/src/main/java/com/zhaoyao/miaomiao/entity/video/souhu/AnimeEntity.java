 ...
 * 动漫 cid = 16
 * 
 * @author lw <16.json> http://open.mb.hd.sohu.com/v4/category/channel/16.json?
 *         api_key=a6719304d387489c3f6b54a56e9f7e87&page=1&is_pgc=1
 */
public class AnimeEntity implements Parcelable {
	...
	public static final Creator<AnimeEntity> CREATOR = new Creator<AnimeEntity>() {

		@Override
		public AnimeEntity[] newArray(int size) {
			return new AnimeEntity[size];
		}

		@Override
		public AnimeEntity createFromParcel(Parcel source) {
			AnimeEntity entivity = new AnimeEntity();
	...
	private long aid;// 1000000562226
