 ...
 * 
 * @author lw <107.json>
 *         http://open.mb.hd.sohu.com/v4/category/channel/107.json?
 *         api_key=a6719304d387489c3f6b54a56e9f7e87&page=1&is_pgc=1
 */
public class DocumentaryEntity implements Parcelable {
	...
	public static final Creator<DocumentaryEntity> CREATOR = new Creator<DocumentaryEntity>() {

		@Override
		public DocumentaryEntity[] newArray(int size) {
			return new DocumentaryEntity[size];
		}

		@Override
		public DocumentaryEntity createFromParcel(Parcel source) {
			DocumentaryEntity entivity = new DocumentaryEntity();
	...
	private String aid;// 1000000561953
	private String album_name;// "美容护肤"
	private String search_name;// "快速消除黑眼圈！4步眼周按摩法攻克黑眼圈!"
	private String cid;// 206
	private String cate_code;// "206;206100"
	private String is_original_code;// -1
	private String ver_high_pic;// "http://photocdn.sohu.com/tvpgc/20160405/6_154c1f20e0fg104SysCutcloud_83406861_7_3b_811_2.jpg"
	private String hor_high_pic;// "http://photocdn.sohu.com/tvpgc/20160405/6_154c1f20e0fg104SysCutcloud_83406861_7_3b_43_1.jpg"
	private String hor_pic;// "http://222.img.pp.sohu.com.cn/p222/2016/4/5/9/1/6_154c1e730eag102SysCutcloud_83406861_7_3b.jpg"
	private String tip;// "1分52秒"
	private String year;// 0
	private String area_id;// 0
	private String update_time;// "2016-04-05 09:32:35"
	private String time_length;// 112
	private String vid;// 83406861
	private String video_name;// "快速消除黑眼圈！4步眼周按摩法攻克黑眼圈!"
	private String video_desc;// "快速消除黑眼圈！4步眼周按摩法攻克黑眼圈!"
	private String is_download;// 0
	private String site;// 2
	private String hor_w8_pic;// "http://photocdn.sohu.com/tvpgc/20160405/6_154c1f20e0fg104SysCutcloud_83406861_7_3b_169_2.jpg"},
