 ...
 */
public class MaternalInfantEntity implements Parcelable {
	...
	public static final Creator<MaternalInfantEntity> CREATOR = new Creator<MaternalInfantEntity>() {

		@Override
		public MaternalInfantEntity[] newArray(int size) {
			return new MaternalInfantEntity[size];
		}

		@Override
		public MaternalInfantEntity createFromParcel(Parcel source) {
			MaternalInfantEntity entivity = new MaternalInfantEntity();
