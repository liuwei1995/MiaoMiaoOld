 ...
 */
public class CookMealEntity implements Parcelable {
	...
	public static final Creator<CookMealEntity> CREATOR = new Creator<CookMealEntity>() {

		@Override
		public CookMealEntity[] newArray(int size) {
			return new CookMealEntity[size];
		}

		@Override
		public CookMealEntity createFromParcel(Parcel source) {
			CookMealEntity entivity = new CookMealEntity();
