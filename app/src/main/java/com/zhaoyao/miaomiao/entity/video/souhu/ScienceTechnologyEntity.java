 ...
 */
public class ScienceTechnologyEntity implements Parcelable {
	...
	public static final Creator<ScienceTechnologyEntity> CREATOR = new Creator<ScienceTechnologyEntity>() {

		@Override
		public ScienceTechnologyEntity[] newArray(int size) {
			return new ScienceTechnologyEntity[size];
		}

		@Override
		public ScienceTechnologyEntity createFromParcel(Parcel source) {
			ScienceTechnologyEntity entivity = new ScienceTechnologyEntity();
