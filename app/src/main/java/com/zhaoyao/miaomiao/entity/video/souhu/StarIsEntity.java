 ...
 */
public class StarIsEntity implements Parcelable {
	...
	public static final Creator<StarIsEntity> CREATOR = new Creator<StarIsEntity>() {

		@Override
		public StarIsEntity[] newArray(int size) {
			return new StarIsEntity[size];
		}

		@Override
		public StarIsEntity createFromParcel(Parcel source) {
			StarIsEntity entivity = new StarIsEntity();
