package com.zhaoyao.miaomiao.helper;
...
public class PlayVideoHelper {
	...
	public static final String APPKEY = "a6719304d387489c3f6b54a56e9f7e87";
	public static final String APIKEY = "a6719304d387489c3f6b54a56e9f7e87";
...
//	public static synchronized void playSohuOnlineVideo(final Context context,final Intent intent,final int startPosition) {
////		Intent intent = new Intent(ACTION_PLAY);
//		intent.setAction(ACTION_PLAY);
//		intent.putExtra(EXTRA_TYPE, TYPE_FOR_SOHU);
//		intent.putExtra(EXTRA_APPKEY, APPKEY);
//		intent.putExtra(EXTRA_SUBPARTNER, APPKEY);
//		intent.putExtra(EXTRA_STARTPOSITION, startPosition < 0 ? 0
//				: startPosition);
//		context.startActivity(intent);
//	}
