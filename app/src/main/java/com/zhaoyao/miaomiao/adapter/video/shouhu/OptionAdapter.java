package com.zhaoyao.miaomiao.adapter.video.shouhu;
...
public class OptionAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = View.inflate(mContext, R.layout.souhu_option_item, null);
		...
		int imgId = -1;
		if (isMulti) {
			imgId = item.seleted ? R.drawable.souhu_checkbox_selected
					: R.drawable.souhu_checkbox_normal;
		} else {
			imgId = item.seleted ? R.drawable.souhu_radio_btn_selected
					: R.drawable.souhu_radio_btn_normal;
		}
