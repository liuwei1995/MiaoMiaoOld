...
public class KuGouLayout extends LinearLayout implements View.OnTouchListener {
	// //////////////////////////////////////////////////////////////////////////////////////////////
	...
	private void shake(float rotation) {
		...
		// 整个动画执行平滑的变化
		ValueAnimator animator = ValueAnimator.ofObject(new FloatEvaluator(),
				rotation, 0f);
