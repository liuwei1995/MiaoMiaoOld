...
import com.zhaoyao.miaomiao.adapter.video.shouhu.OptionAdapter;
import com.zhaoyao.miaomiao.adapter.video.shouhu.OptionAdapter.OptionItem;
import com.zhaoyao.miaomiao.util.souhu.DialogUtil;
import com.zhaoyao.miaomiao.util.souhu.DialogUtil.OnOptionItemClickListener;
...
public class SohuControllerWindow extends PopupWindow {
	...
	protected void init(Context context) {
		...
		mContentView = inflater.inflate(R.layout.souhu_popup_controller, null);
	...
	private void showDefinitionSelector() {
		...
		for (Integer definition : definitions) {
			View definitionItemView = View.inflate(mContext,
					R.layout.souhu_definition_item, null);
	...
	private final OnClickListener mOnDefinitioItemClick = new OnClickListener() {
		@Override
		public void onClick(View v) {
	...
	private void clickVolumn(View v) {
		...
		int nextValue = 0;
		if (MUTE.equals(tag)) {
			ivVolumn.setImageResource(R.drawable.souhu_ic_volume);
			ivVolumn.setTag("VOLUME");
			nextValue = mLastVolumn;
		} else {
			mLastVolumn = mAudioManager
					.getStreamVolume(AudioManager.STREAM_MUSIC);
			ivVolumn.setImageResource(R.drawable.souhu_ic_mute);
